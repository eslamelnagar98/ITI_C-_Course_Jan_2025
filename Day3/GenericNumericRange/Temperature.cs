...
//    public int CompareTo(Temperature<TUnit> other) 
//        => Value.CompareTo(other.Value);
//    public override bool Equals(object? obj) 
//        => obj is Temperature<TUnit> other && Equals(other);
//    public override int GetHashCode() 
//        => HashCode.Combine(Value, typeof(TUnit));
//    public static bool operator ==(Temperature<TUnit> left, Temperature<TUnit> right) 
//        => left.Equals(right);
//    public static bool operator !=(Temperature<TUnit> left, Temperature<TUnit> right) 
//        => !(left == right);
//    public static bool operator <(Temperature<TUnit> left, Temperature<TUnit> right) 
